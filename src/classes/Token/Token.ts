...
export default class Token {
    ...
    static parse(token: string|Token) {
        // WC.RE.fz_z_MVQj8UQ3lY_UmrUjekE_2U4dn8d4WIkfHqJ7ZQRN-O1BNu6xfKINhKCrv1I.ljlioshm.ljlirzu1
        // WC.AC.fz_z_MVQj8UQ3lY_UmrUjekE_2U4dn8d4WIkfHqJ7ZQRN-O1BNu6xfKINhKCrv1I.ljlioshm.ljlirzu1
        ...
        if (prefixPart !== "WC") throw new Error(`Invalid token: prefix should be WC but is ${prefixPart}`);
